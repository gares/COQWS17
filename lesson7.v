...
- The matrix can be seen as the familiy of its row vectors.
 *WARNING* This is the english convention, which is opposite to the english convension.
 - this means that composition should be done left to right: applying A to u is
  <pre>u *m A</pre>
- the scope MS (matrix space) contains all notions connected to matrices as spaces
- The matrix A represents its image A.
*)
